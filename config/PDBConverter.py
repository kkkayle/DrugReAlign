...
MGLTOOLS_PYTHON = "/path/to/mgltools/MGLTools-1.5.6/bin/pythonsh"
PREPARE_RECEPTOR_SCRIPT = "/path/to/mgltools/MGLTools-1.5.6/MGLToolsPckgs/AutoDockTools/Utilities24/prepare_receptor4.py"
